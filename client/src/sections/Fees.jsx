...
export default function Fees() {
  return (
    <section id="fees" className="py-20 px-6 bg-zinc-50 dark:bg-zinc-900/40">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
            Choose a learning plan based on your availability. All plans include
            a free demo class before enrollment.
          </p>
        </div>
        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div className="rounded-3xl border bg-white dark:bg-zinc-900 p-8 text-center">
            ...
            <ul className="space-y-3 text-sm text-gray-800 dark:text-gray-200 mb-8 text-left">
              <li className="flex gap-3">
                <CheckIcon /> 3 days per week
              </li>
              <li className="flex gap-3">
                <CheckIcon /> 30 minutes per class
              </li>
              <li className="flex gap-3">
                <CheckIcon /> One-to-one online
              </li>
              <li className="flex gap-3">
                <CheckIcon /> Free demo class
              </li>
            </ul>
            <div
          ...
          <div className="rounded-3xl border-2 border-emerald-600 bg-white dark:bg-zinc-900 p-8 text-center scale-[1.02]">
            ...
            <ul className="space-y-3 text-sm text-gray-800 dark:text-gray-200 mb-8 text-left">
              ...
              <li className="flex gap-3 font-semibold text-emerald-700">
                <CheckIcon /> Free demo class
              </li>
            </ul>
            <div
          ...
          <div className="rounded-3xl border bg-white dark:bg-zinc-900 p-8 text-center">
            ...
            <ul className="space-y-3 text-sm text-gray-800 dark:text-gray-200 mb-8 text-left">
              ...
              <li className="flex gap-3">
                <CheckIcon /> 60 minutes per class
              </li>
              <li className="flex gap-3">
                <CheckIcon /> One-to-one online
              </li>
        ...
        <p className="mt-12 text-center text-sm text-gray-600 dark:text-gray-400">
          Female teachers are available for girls and women. Special discounts
          for siblings may apply.
        </p>
      </div>
    </section>
  );
